...
<?php
	...
	echo '<div class="form-group row">';
		echo CHtml::label('Abordagem*: ', 'lblAbordagem', array('class'=>'alinharDireita col-sm-2 col-form-label'));
		echo '<div class="col-sm-10">';
			echo CHtml::activeTextField($tipoAnalise, 'NomeTipoAnalise', array('required'=>true, 'class'=>'form-control'));
			echo '<div class="invalid-feedback">Por favor, insira o tipo de abordagem.</div>';
		echo '</div>';
	echo '</div>';
	...
	echo '<div class="form-group row">';
		...
		echo '<div class="col-sm-8">';
			echo CHtml::checkBox('TipoAnalise[IndicadorExclusao]', $tipoAnalise->IndicadorExclusao == NULL ? true : false, array('style'=>'margin-top: 13px;'));
		echo '</div>';
	echo '</div>';
