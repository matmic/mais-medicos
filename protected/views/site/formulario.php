...
<?php
	...
	echo '<div class="form-group row">';
		...
		echo '<div class="col-sm-10">';
			echo CHtml::dropDownList('Artigo[ObjetoPesquisa]', '', TipoObjetivo::getTiposObjetivos(), array('encode'=>false, 'required'=>true, 'class'=>'form-control'));
	...
	echo '<div class="form-group row">';
		...
		echo '<div class="col-sm-10">';
			echo CHtml::dropdownList('Artigo[Instituicao]', '', TipoObjetivo::getTiposObjetivos(), array('encode'=>false, 'multiple'=>true, 'required'=>true, 'class'=>'form-control'));
	...
	echo '<div class="form-group row">';
		...
		echo '<div class="col-sm-4">';
			echo CHtml::dropdownList('Artigo[Abrangencia]', '', array(), array('required'=>true, 'class'=>'form-control'));
