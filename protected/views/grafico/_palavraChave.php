<h4 class="c-grey-900 mB-20">Publicações por Palavra-chave</h4>
<div class="mT-30">
	<?php
		echo CHtml::beginForm(Yii::app()->createUrl('grafico/palavra'), 'GET', array('id'=>'needs-validation', 'class'=>'container', 'noValidate'=>""));
			echo '<div class="form-group row">';
				echo CHtml::label('Número de palavras-chave*: ', 'lblPalavra', array('class'=>'col-sm-3 col-form-label alinharDireita'));
